...
const Form=({onAddItems})=>{
    ...
    return(
        ...
        <form className="add-form flex justify-center items-center" onSubmit={handlerSubmit}>
            ...
            <select className="p-2 rounded-lg bg-yellow-200 mr-3" value={quantity} onChange={handleChange }>
            ...
            <input type="text" className="p-2 rounded-lg bg-yellow-200 mr-3" value={description} onChange={handlerInputValue} placeholder="item..." />
